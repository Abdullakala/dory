...
import { formatBytes } from '@/app/(app)/[team]/components/table-browser/components/stats/components/formatters';
...
export function PostgresTableIndexesTab({ database, table, emptyText }: PostgresTableIndexesTabProps) {
    ...
    const loadRows = React.useCallback(async () => {
        ...
        try {
            ...
            console.error('Failed to fetch postgres table indexes:', error);
            setRows([]);
        } finally {
            setLoading(false);
        }
