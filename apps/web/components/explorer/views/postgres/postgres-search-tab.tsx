...
import { splitQualifiedName, useExplorerConnectionContext } from './postgres-shared';
...
export function PostgresSearchTab({ baseParams, database, placeholder, emptyText }: PostgresSearchTabProps) {
    ...
    const loadRows = React.useCallback(async () => {
        ...
        try {
            ...
            console.error('Failed to fetch postgres search data:', error);
            setRows([]);
        } finally {
            setLoading(false);
        }
