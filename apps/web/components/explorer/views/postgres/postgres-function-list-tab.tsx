...
type PostgresFunctionListTabProps = {
    database: string;
    schema?: string;
...
export function PostgresFunctionListTab(props: PostgresFunctionListTabProps) {
    ...
    const loadRows = React.useCallback(async () => {
        ...
        try {
            ...
            console.error('Failed to fetch postgres functions:', error);
            setRows([]);
        } finally {
            setLoading(false);
        }
